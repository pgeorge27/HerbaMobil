	...
	var self = $.mobile.HerbaMobil  = {
			...
			crearProductos: function(){
				self.transaction(function(tx){
				    ...
				    tx.executeSql('INSERT INTO Productos (nombre, categoria, descripcion, sabores, beneficios, foto) VALUES (?,?,?,?,?,?)',["Mezcla para Preparar Bebida Nutricional", "1", "El batido nutricional de Herbalife contiene proteina de soya (9gr. por porcion), fibra y 12 vitaminas y minerales para una nutricion completa.", "Vainilla, chocolate, fresa, frutas tropicales, galletas con crema.", "Nutritivo y saludable, buena fuente de vitaminas y minerales, contiene fibra.", "./imagenes/mezclaParaBebida.png"]);
